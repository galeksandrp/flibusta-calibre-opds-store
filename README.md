...
Плагин для Calibre, который позволяет скачивать книжки с [flibusta.is](https://flibusta.is/)

## Предыстория

Решил в очередной раз попробовать Calibre для хранения книжек, разумеется, сразу же проверил как работает с флибустой.
Оказалось, что никак. Был какой-то старый [плагин](https://flibusta.is/node/159828), но сейчас он не работает, потому что формат выдачи поменялся.
